...
<head>
    ...
    <header>
        <a href="#" class="logo"><span>R</span>econnaissance et <span>I</span>ndexation du <span>D</span>ocuments <span>É</span>crit</a>
            ...
            <table>
                ...
                <tbody>
                    ...
                    if ($numEquipe == $responsable) {
                       echo'<button><a href="ajoutercher.php?nbrequipe='.$numEquipe.'">Ajouter</a></button>';
                    }
