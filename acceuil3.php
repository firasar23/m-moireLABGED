...
<body>
    ...
    <ul class="navbar">
        ...
        <li><a href="affequipe3.php?numEquipe=<?php echo $numequipe ?>" onclick="toggleMenu();">Research Teams</a></li>
        <li><a href="affthese.php" onclick="toggleMenu();">Research projects</a></li>
